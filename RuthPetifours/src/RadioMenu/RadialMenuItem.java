...
public class RadialMenuItem extends Group implements ChangeListener<Object> {
    ...
    protected DoubleProperty length = new SimpleDoubleProperty(25);

    protected DoubleProperty innerRadius = new SimpleDoubleProperty(30);

    protected DoubleProperty radius = new SimpleDoubleProperty(50);

    protected DoubleProperty offset = new SimpleDoubleProperty(3);
