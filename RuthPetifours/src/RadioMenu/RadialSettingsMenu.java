...
import RadioMenu.RadialMenuItem;
import RadioMenu.RadialMenuItemBuilder;
...
public class RadialSettingsMenu extends Group {
	...
	addMenuItem("Images/9.png");
	addMenuItem("Images/2.png");
	addMenuItem("Images/3.png");
	addMenuItem("Images/4.png");
	addMenuItem("Images/5.png");
	addMenuItem("Images/6.png");
	addMenuItem("Images/7.png");
	addMenuItem("Images/8.png");
